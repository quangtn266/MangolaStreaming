...
import com.quangtn.streaming.aggregations.AggregatedBidResp;
...
public class BidRespWindowCountFunction implements WindowFunction<BidResp, AggregatedBidResp,
    ...
    public void apply(
            ...
            final Collector<AggregatedBidResp> collector
            ) throws Exception {
        ...
        val aggregation = AggregatedBidResp.builder().uuid(uuid).advId(advId).sourceId(sourceId)
